...
- Document for learning and teaching, not just reference
- Share what doesn't work as openly as what does
- Build with accessibility and inclusion from day one
- Seek opportunities to help underserved communities
- Remember: to teach is to learn - we grow through sharing
...
- Write documentation as teaching material, not just reference
- Include "what doesn't work" alongside "what works"
- Make documentation accessible for community learning
- Document for contribution, not just consumption
